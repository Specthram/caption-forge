...
- **Quality & diversity** — MUSIQ / TOPIQ / LAION-Aes / Q-Align scoring, a
  ...
  **Quality report**.
- **Captioning** — batch VLM generation (Qwen2.5-VL, Qwen3-VL, Qwen3.6, Gemma 3,
  Gemma 4, JoyCaption, Mistral Small 3.2…), per-media versions with autosave,
  integrity review, SigLIP 2
